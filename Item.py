...
class ItemFrame(wx.Frame):
    ...
    def populate_details_panel(self):
        ...
        ctrl(self, 'label:orders.root.filemaker_quote').SetLabel(filemaker_quote)
        ctrl(self, 'label:orders.root.sales_order').SetLabel(sales_order)
        ctrl(self, 'label:orders.root.item').SetLabel(item)
        ctrl(self, 'label:orders.root.production_order').SetLabel(production_order)
        ctrl(self, 'label:orders.root.material').SetLabel(material)
        ctrl(self, 'label:orders.root.hierarchy').SetLabel(hierarchy)
        ctrl(self, 'label:orders.root.model').SetLabel(model)
        ctrl(self, 'label:orders.root.description').SetLabel(description)
        ctrl(self, 'label:orders.root.serial').SetLabel(serial)
        ...
        ctrl(self, 'label:orders.root.address').SetLabel(address)
